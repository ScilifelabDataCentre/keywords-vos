...
export default (env = defaultEnv) => {
  ...
  const copyPatternsImages = [
    {
      ...
      to: absolute('dist', bundleName, 'vosviewer-online/images/vosviewer-favicon.png'),
    },
    {
      from: resolve(__dirname, 'src/assets/images/vosviewer-online-thumbnail.png'),
      to: absolute('dist', bundleName, 'vosviewer-online/images/vosviewer-online-thumbnail.png'),
    },
    {
      from: resolve(__dirname, 'src/assets/images/vosviewer-online-thumbnail-twitter.png'),
      to: absolute('dist', bundleName, 'vosviewer-online/images/vosviewer-online-thumbnail-twitter.png'),
    }
  ];
  ...
  config.output = {
    ...
    publicPath: env.dev ? '/vosviewer/' : undefined,
    globalObject: 'this'
  };
